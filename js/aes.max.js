...
function v_cookie(n, t) {
    var TOKEN_SERVER_TIME = Date.now()+'.162';
    var r, e, a;
    r = e = a = n;
    var u, c, s;
    u = c = s = t;
    ...
    !function (n) {
        ...
        function V() {
            ...
            var a, o, i;
            a = o = i = u;
            for (var c = 12, s = o[2]; s < An[o[111]]; s++)
                if (An[s].test(c))
                    return s + e[54];
            return i[2]
        }
        ...
        function bn() {
            return new u[27](ot(r[190]), u[80]).test(12)
        }
