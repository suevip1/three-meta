function ccc(e, t) {
    e.constructor == String ? e = t && "binary" === t.encoding ? d.stringToBytes(e) : o.stringToBytes(e) : l(e) ? e = Array.prototype.slice.call(e, 0) : Array.isArray(e) || e.constructor === Uint8Array || (e = e.toString());
...
var c = {
    ...
    ,
    _gg: function (a, b, e, t, n, s, r) {
        var o = a + (b & t | e & ~t) + (n >>> 0) + r;
        return (o << s | o >>> 32 - s) + b
    }
    ,
    _hh: function (a, b, e, t, n, s, r) {
        var o = a + (b ^ e ^ t) + (n >>> 0) + r;
        return (o << s | o >>> 32 - s) + b
    }
    ,
    _ii: function (a, b, e, t, n, s, r) {
        var o = a + (e ^ (b | ~t)) + (n >>> 0) + r;
        return (o << s | o >>> 32 - s) + b
    }
}
